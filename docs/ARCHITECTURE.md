...
`opportunity-tracker/1.0` -- an automated tracker, never a browser string, and with
nothing that identifies the owner (no email, name or repo link since 2026-09-26) -- and
are never retried
